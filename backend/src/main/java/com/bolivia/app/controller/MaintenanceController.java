...
public class MaintenanceController {
    ...
    // 내 신고 목록/상태 조회
    @GetMapping
    public ResponseEntity<List<MaintenanceDto.TaskDetail>> myTasks(@com.bolivia.app.security.CurrentUserId Long uid) {
        return ResponseEntity.ok(maintenanceService.listMyTasks(uid));
    }

    // 신고 생성
    @PostMapping
    public ResponseEntity<?> create(@RequestBody MaintenanceDto.CreateRequest req, @com.bolivia.app.security.CurrentUserId Long uid) {
