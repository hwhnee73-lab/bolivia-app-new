...
public class UserBatchService {
    ...
    private void upsertOne(UserBatchDto.BatchRowPreview r) {
        Long householdId = ensureHousehold(r.getDong(), r.getHo());
        ...
        user.setRole(User.Role.valueOf(r.getRole()));
        user.setStatus(User.Status.valueOf(r.getStatus()));
