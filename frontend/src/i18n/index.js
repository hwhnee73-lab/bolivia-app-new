  ...
  en: {
    translation: {
      ...
      finance: {
        ...
        sections: {
          incomesMonthly: "Incomes (Monthly)",
          expensesMonthItem: "Expenses (Month/Item)",
          delinquencyRange: "Delinquency (Range)",
        },
        table: {
          month: "Month",
          item: "Item",
        ...
        errors: {
          ...
          applyFilterFailed: "Failed to apply filter.",
        },
      },
      billing: {
        steps: {
        ...
        columnsHelp:
          "Columns: building_number, unit_number, bill_month(YYYY-MM), total_amount, due_date(YYYY-MM-DD), status",
        actions: {
          upload: "Upload",
        ...
        result: {
          ...
          summary:
            "{{total}} total, {{upserted}} processed, {{skipped}} skipped",
        },
        errors: {
      ...
      communication: {
        ...
        form: {
          ...
          contentPlaceholder:
            "The generated announcement content will appear here.",
        },
        actions: {
        ...
        success: {
          published: "The announcement has been published successfully.",
        },
      },
      reservations: {
      ...
      bills: {
        ...
        success: {
          ...
          created: "A new invoice has been registered.",
        },
      },
      users: {
        ...
        success: {
          ...
          created: "A new user has been registered.",
        },
      },
      tasks: {
        ...
        success: {
          ...
          created: "A new request has been registered.",
        },
      },
      dashboard: {
        greeting: "Hello,",
      ...
      maintenance: {
        ...
        actions: {
          newReportPlus: "+ Report New Issue",
          submit: "Submit Report",
        },
        form: {
          newTitle: "Report New Issue",
      ...
      reservation: {
        ...
        modal: {
          ...
          availabilityNote:
            "Availability based on your reservations. It may vary.",
        },
        errors: {
        ...
        success: {
          requested: "Reservation request for {{name}} has been sent.",
  ...
  ko: {
    translation: {
      ...
      finance: {
        ...
        sections: {
          incomesMonthly: "수입 (월별)",
          expensesMonthItem: "지출 (월/항목)",
          delinquencyRange: "연체/미납 (기간)",
        },
        table: {
          month: "월",
          item: "항목",
        ...
        errors: {
          ...
          applyFilterFailed: "필터 적용에 실패했습니다.",
        },
      },
      billing: {
        ...
        columnsHelp:
          "컬럼: building_number, unit_number, bill_month(YYYY-MM), total_amount, due_date(YYYY-MM-DD), status",
        actions: {
          upload: "업로드",
        ...
        result: {
          title: "업로드 확정 결과",
          summary:
            "총 {{total}}건 중 {{upserted}}건 처리, {{skipped}}건 건너뜀",
        },
        errors: {
      ...
      bills: {
        ...
        errors: {
          loadFailed: "청구서를 불러오지 못했습니다.",
          deleteFailed: "청구서를 삭제하지 못했습니다.",
          operationFailed: "작업에 실패했습니다.",
        },
        success: {
          deleted: "청구서가 삭제되었습니다.",
          updated: "청구서가 수정되었습니다.",
          created: "새 청구서가 등록되었습니다.",
        },
      },
      users: {
        title: "사용자 관리",
      ...
      tasks: {
        ...
        errors: {
          loadFailed: "요청 목록을 불러오지 못했습니다.",
          deleteFailed: "요청을 삭제하지 못했습니다.",
          operationFailed: "작업에 실패했습니다.",
        },
        success: {
          deleted: "요청이 삭제되었습니다.",
          updated: "요청이 수정되었습니다.",
          created: "새 요청이 등록되었습니다.",
        },
      },
      dashboard: {
        greeting: "안녕하세요,",
      ...
      maintenance: {
        ...
        form: {
          ...
          typeLabel: "문제 유형",
          detailLabel: "상세 설명",
          detailPlaceholder: "문제를 자세히 작성하세요.",
        },
        list: { title: "내 요청 상태" },
        errors: {
          loadFailed: "요청 목록을 불러오지 못했습니다.",
          createFailed: "요청 등록 실패",
        },
      ...
      reservation: {
        ...
        modal: {
          ...
          unavailable: "불가",
          availabilityNote:
            "사용자의 예약 기준으로 표시됩니다. 변동될 수 있습니다.",
        },
        errors: {
          loadFailed: "예약 데이터를 불러오지 못했습니다.",
          selectDate: "날짜를 선택하세요.",
          createFailed: "예약 생성 실패",
          cancelFailed: "예약 취소 실패",
        },
        success: {
          requested: "{{name}} 예약 요청이 전송되었습니다.",
    ...
    translation: {
      ...
      finance: {
        ...
        filters: {
          from: "Desde (AAAA-MM)",
          to: "Hasta (AAAA-MM)",
          category: "Categoría (Gastos)",
        },
        sections: {
          incomesMonthly: "Ingresos (Mensual)",
          expensesMonthItem: "Gastos (Mes/Ítem)",
          delinquencyRange: "Mora (Periodo)",
        },
        table: {
          month: "Mes",
          item: "Ítem",
        ...
        errors: {
          ...
          applyFilterFailed: "No se pudo aplicar el filtro.",
        },
      },
      billing: {
        steps: {
          upload: "Subir",
          preview: "Vista previa de validación",
          confirm: "Confirmar",
        },
        fileLabel: "Archivo CSV o XLSX",
        columnsHelp:
          "Columnas: building_number, unit_number, bill_month(YYYY-MM), total_amount, due_date(YYYY-MM-DD), status",
        actions: {
          upload: "Subir",
        ...
        preview: {
          ...
          token: "Token: {{token}}",
          invalidNote:
            "Hay filas inválidas; la confirmación está deshabilitada.",
        },
        table: {
          row: "Fila",
          building: "Edif",
          unit: "Unidad",
          billMonth: "Mes de cobro",
          amount: "Monto",
          dueDate: "Vencimiento",
          status: "Estado",
        ...
        result: {
          ...
          summary:
            "{{total}} en total, {{upserted}} procesadas, {{skipped}} omitidas",
        },
        errors: {
      ...
      reservations: {
        ...
        errors: {
          loadFailed: "No se pudo cargar la lista de reservas.",
      ...
      bills: {
        ...
        form: {
          ...
          newTitle: "Registrar Nueva Factura",
        },
        table: {
          unit: "Unidad",
          month: "Mes",
        ...
        errors: {
          loadFailed: "No se pudo cargar la lista de facturas.",
          deleteFailed: "No se pudo eliminar la factura.",
          operationFailed: "La operación falló.",
        },
        success: {
          deleted: "La factura ha sido eliminada.",
          updated: "La factura ha sido actualizada.",
          created: "Se ha registrado una nueva factura.",
        },
      },
      users: {
        ...
        success: {
          ...
          updated: "La información del usuario ha sido actualizada.",
          created: "Se ha registrado un nuevo usuario.",
        },
      },
      tasks: {
        ...
        errors: {
          loadFailed: "No se pudo cargar la lista de solicitudes.",
          deleteFailed: "No se pudo eliminar la solicitud.",
          operationFailed: "La operación falló.",
        },
        success: {
          deleted: "La solicitud ha sido eliminada.",
          updated: "La solicitud ha sido actualizada.",
          created: "Se ha registrado una nueva solicitud.",
        },
      },
      dashboard: {
        greeting: "Hola,",
      ...
      community: {
        title: "Comunidad",
        actions: {
          newPostPlus: "+ Crear Nueva Publicación",
          publish: "Publicar",
        },
        form: {
          newTitle: "Nueva Publicación",
          titlePlaceholder: "Título",
          contentPlaceholder: "Escriba el contenido aquí.",
        },
        list: {
        ...
        errors: {
          loadFailed: "No se pudo cargar la lista de publicaciones.",
          createFailed: "Falló el registro de la publicación.",
        },
      ...
      maintenance: {
        ...
        actions: {
          newReportPlus: "+ Reportar Nuevo Problema",
          submit: "Enviar Reporte",
        },
        form: {
          newTitle: "Reportar Nuevo Problema",
          typeLabel: "Tipo de Problema",
          detailLabel: "Descripción Detallada",
          detailPlaceholder: "Describa el problema en detalle.",
        },
        list: { title: "Estado de Mis Solicitudes" },
        errors: {
          loadFailed: "No se pudo cargar la lista de solicitudes.",
          createFailed: "Falló el registro de la solicitud.",
        },
      ...
      reservation: {
        ...
        modal: {
          ...
          availabilityNote:
            "Disponibilidad basada en tus reservas. Puede variar.",
        },
        errors: {
          loadFailed: "No se pudieron cargar los datos de reserva.",
        ...
        success: {
          requested: "La solicitud de reserva para {{name}} ha sido enviada.",
          canceled: "La reserva ha sido cancelada.",
        },
...
export const setLocale = (nextLng) => {
  ...
  try {
    localStorage.setItem(STORAGE_KEY, nextLng);
  } catch (e) {}
};
