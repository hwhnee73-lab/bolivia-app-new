...
const resources = {
  en: {
    translation: {
      ...
      reportsUI: {
        tabs: {
          unitAccount: "Unit Account Statement",
          historical: "Historical Portfolio Control",
          accumulated: "Accumulated Portfolio Report",
        },
        filters: {
          ...
          viewSummary: "Summary",
          viewDistributed: "Distributed",
          unitRequired: "Unit *",
          unit: "Unit",
          cutoffRequired: "Cutoff date *",
          includeDue: "Include portfolio to mature?",
          year: "Year",
          none: "No selection",
          allYears: "All Years",
        },
        ...
        actions: {
          ...
          exportExcelDetail: "Export Excel Detail",
          print: "Print Report",
          downloadAll: "Download All",
        },
        search: "Search",
        condoPlaceholder: "Condominium Lomas del Sol",
      },
      billing: {
        steps: {
          upload: "Upload",
    ...
    translation: {
      ...
      reportsUI: {
        ...
        actions: {
          ...
          exportExcelDetail: "엑셀 상세 내보내기",
          print: "리포트 인쇄",
          downloadAll: "전체 다운로드",
        },
        search: "검색",
        condoPlaceholder: "Lomas del Sol 콘도",
      },
      billing: {
  ...
  es: {
    translation: {
      ...
      reportsUI: {
        tabs: {
          unitAccount: "Estado de Cuenta de Unidades",
          historical: "Control Histórico de Cartera",
          accumulated: "Reporte de Cartera Acumulada",
        },
        filters: {
          title: "Refine su búsqueda",
          view: "Vista de Reporte",
          viewDetailed: "Detallado",
          viewSummary: "Resumido",
          viewDistributed: "Distribuida",
          unitRequired: "Unidad *",
          unit: "Unidad",
          cutoffRequired: "Fecha de corte *",
          includeDue: "¿Incluir cartera por vencer?",
          year: "Año",
          none: "Ninguna selección",
        ...
        columns: {
          ...
          mas120: "> 120 días",
          total: "Total",
          valorExpensa: "Valor por expensa",
        ...
        actions: {
          ...
          exportExcelDetail: "Exportar a Excel Detalle",
          print: "Imprimir Reporte",
          downloadAll: "Descargar Todas",
        },
        search: "Buscar",
        condoPlaceholder: "Condominio Lomas del Sol",
      },
      billing: {
        steps: {
          upload: "Subir",
