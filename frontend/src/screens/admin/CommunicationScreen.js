  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6 md:p-8">
      ...
      <div className="space-y-4">
        <div>
          <label
            htmlFor="announcement-prompt"
            className="font-semibold text-gray-700"
          >
            {t("communication.form.promptLabel")}
          </label>
          <input
            ...
            type="text"
            placeholder={t("communication.form.promptPlaceholder")}
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full p-3 rounded bg-gradient-to-r from-fuchsia-600 to-violet-500 hover:from-fuchsia-700 hover:to-violet-600 text-white font-bold transition-colors disabled:opacity-50"
        >
          {isLoading
            ? t("communication.actions.generating")
            : t("communication.actions.generate")}
        </button>
        ...
        <div>
          <label
            ...
            className="font-semibold text-gray-700"
          >
            {t("communication.form.titleLabel")}
          </label>
          <input
            ...
            type="text"
            placeholder={t("communication.form.titlePlaceholder")}
        ...
        <div>
          <label
            ...
            className="font-semibold text-gray-700"
          >
            {t("communication.form.contentLabel")}
          </label>
          <textarea
            id="announcement-content"
            value={content}
            onChange={(e) => setContent(e.target.value)}
            placeholder={t("communication.form.contentPlaceholder")}
            rows="8"
            className="w-full mt-1 p-2 border rounded-md bg-gray-50"
          ></textarea>
        </div>
        ...
        <button
          ...
          className="w-full p-3 rounded bg-sky-600 text-white hover:bg-sky-700 font-bold transition-colors disabled:opacity-50"
        >
          {isPublishing
            ? t("communication.actions.publishing")
            : t("communication.actions.publishAll")}
        </button>
      </div>
    </div>
  );
