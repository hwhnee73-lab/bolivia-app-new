      ...
      <div className="relative space-y-5">
        ...
        <div className="bg-white p-4 rounded-lg shadow">
          ...
          {isEditing ? (
            <div className="space-y-3">
              ...
              <div className="flex gap-2 pt-2">
                <button
                  onClick={handleSave}
                  disabled={isLoading}
                  className="w-full bg-teal-600 text-white p-2 rounded text-sm hover:bg-teal-700 disabled:opacity-50"
                >
                  {isLoading
            ...
            <>
              ...
              />
              <InfoRow
                label={t("profile.info.sessionEmail")}
        ...
        <div className="bg-white p-4 rounded-lg shadow">
          <h4 className="text-md font-semibold mb-2">
            {t("profile.sections.unitInfo")}
          </h4>
          <InfoRow
            label={t("profile.unit.building")}
            value={currentUser?.household?.building_number}
          />
          <InfoRow
            label={t("profile.unit.unit")}
            value={currentUser?.household?.unit_number}
          />
        </div>

        <button
          onClick={handleLogout}
          className="w-full text-center text-red-500 hover:text-red-400 font-semibold pt-2"
        >
